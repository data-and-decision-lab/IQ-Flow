# Config script for Actor Critic algorithm for 7x7 Cleanup
...
def get_config():
    ...
    config.pg.lr_actor = 6.73e-4
    config.pg.lr_v = 5.54e-4
    ...
    config.main.dir_name = 'cleanup_small_id_decentralized'
    config.main.exp_name = 'cleanup_pg'

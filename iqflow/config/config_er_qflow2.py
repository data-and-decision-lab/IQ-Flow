# Config script for IQFlow algorithm for Escape Room (10, 5)
...
def get_config():
    ...
    config.qflow.epsilon_start = 0.5
    ...
    config.main.dir_name = 'big_er_n10_5_qflow'
    config.main.exp_name = 'er_qflow2_pg'
